...
int main(int argc, char *argv[]) {
  ...
  if (argc != 2) {
    ...
    // give the matrix size as input
    // in memory they are stored as 1D arrays for GPU optimisation
  ...
  // Initialize matrices
  // if you wish, you can change the matrix initial values
  // the third element [3] is the matrix multiplication result
  // initialize it to 0
